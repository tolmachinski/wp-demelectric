<?php
/**
 * The Template for displaying page info in Details Panel
 *
 * This template can be overridden by copying it to yourtheme/fibosearch/details-panel/page.php.
 */
...
<div class="dgwt-wcas-details-inner dgwt-wcas-details-page dgwt-wcas-details-cpt">
	...
	<?php do_action( 'dgwt/wcas/details_panel/page/container_before', $vars ); ?>

	<div class="dgwt-wcas-product-details">

		<?php do_action( 'dgwt/wcas/details_panel/page/image_before', $vars ); ?>
		...
		<?php do_action( 'dgwt/wcas/details_panel/page/image_after', $vars ); ?>
	...
	<?php do_action( 'dgwt/wcas/details_panel/page/container_after', $vars ); ?>
