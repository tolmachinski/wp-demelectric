 ...
 */
namespace _PhpScoper99e9e79e8301\League\OAuth2\Client\Grant;

use _PhpScoper99e9e79e8301\League\OAuth2\Client\Grant\Exception\InvalidGrantException;
/**
...
class GrantFactory
{
    ...
    protected function registerDefaultGrant($name)
    {
        ...
        $class = '_PhpScoper99e9e79e8301\\League\\OAuth2\\Client\\Grant\\' . $class;
