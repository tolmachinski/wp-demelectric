...
namespace _PhpScoper99e9e79e8301\GuzzleHttp\Handler;

use _PhpScoper99e9e79e8301\GuzzleHttp\Exception\ConnectException;
use _PhpScoper99e9e79e8301\GuzzleHttp\Exception\RequestException;
use _PhpScoper99e9e79e8301\GuzzleHttp\Promise as P;
use _PhpScoper99e9e79e8301\GuzzleHttp\Promise\FulfilledPromise;
use _PhpScoper99e9e79e8301\GuzzleHttp\Promise\PromiseInterface;
use _PhpScoper99e9e79e8301\GuzzleHttp\Psr7\LazyOpenStream;
use _PhpScoper99e9e79e8301\GuzzleHttp\TransferStats;
use _PhpScoper99e9e79e8301\GuzzleHttp\Utils;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf): void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \_PhpScoper99e9e79e8301\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \_PhpScoper99e9e79e8301\GuzzleHttp\Psr7\Utils::streamFor($sink);
