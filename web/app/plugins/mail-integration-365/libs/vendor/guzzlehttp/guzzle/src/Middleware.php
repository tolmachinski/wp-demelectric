...
use _PhpScoper99e9e79e8301\GuzzleHttp\Cookie\CookieJarInterface;
...
use _PhpScoper99e9e79e8301\Psr\Log\LoggerInterface;
/**
        ...
        return static function (callable $handler) : callable {
            return static function ($request, array $options) use($handler) {
                if (empty($options['cookies'])) {
                    ...
                    throw new \InvalidArgumentException('_PhpScoper99e9e79e8301\\cookies must be an instance of GuzzleHttp\\Cookie\\CookieJarInterface');
                }
