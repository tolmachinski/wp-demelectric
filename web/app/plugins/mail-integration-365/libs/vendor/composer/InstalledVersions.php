 ...
 */
namespace _PhpScoper99e9e79e8301\Composer;

use _PhpScoper99e9e79e8301\Composer\Autoload\ClassLoader;
use _PhpScoper99e9e79e8301\Composer\Semver\VersionParser;
/**
...
class InstalledVersions
{
    ...
    private static function getInstalled()
    {
        if (null === self::$canGetVendors) {
            self::$canGetVendors = \method_exists('_PhpScoper99e9e79e8301\\Composer\\Autoload\\ClassLoader', 'getRegisteredLoaders');
        }
        $installed = array();
